...
main = Tk()
main.title("Detection of Fake Online Reviews using Semi-Supervised and Supervised Learning")
...
def predict():
    ...
    for i in range(len(testData)):
        msg = testData._get_value(i, 'Reviews')
        review = msg.lower()
...
font = ('times', 15, 'bold')
title = Label(main, text='Detection of Fake Online Reviews using Semi-Supervised and Supervised Learning')
